#***Sergey Kurmel***
в CV добавьте своЄ фото или аватарку. ‘ото предпочтительнее
![mountains](/img/mountan.png "ѕейзаж с горами")
...
Function GetUserDocInternetAddress (username As String) As String
	...
	ForAll dbNames In books
		If ( dbNames.IsPublicAddressBook ) And ( Not done )  Then			
			...
			Call dbNames.Open( "", "" )
			'Print "»спользуем  names.nsf на сервере "+dbNames.Server
...
Electronic and optical hardware engineering 2003Ц2008
